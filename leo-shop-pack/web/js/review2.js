(function (e) {
    ...
    s.style.lineHeight = "200px", "200px" === e(s).css("lineHeight") && n.push("lineHeight"), s.style.lineHeight = "", e.fn.autosize = function (i) {
...
(function (e, t) {
    ...
    n = function () {
        function t(t, n) {
            ...
            this.createStars();
            this.syncRating();
            this.$el.on("mouseover.ratings", "i", function (e) {
                return o.syncRating(o.$el.find("i").index(e.currentTarget) + 1)
            });
            this.$el.on("mouseout.ratings", function () {
                return o.syncRating()
            });
            this.$el.on("click.ratings", "i", function (e) {
                return o.setRating(o.$el.find("i").index(e.currentTarget) + 1)
            });
            this.$el.on("ratings:change", this.options.change)
        }
        ...
        t.prototype.createStars = function () {
            ...
            for (e = 1, t = this.options.numStars; 1 <= t ? e <= t : e >= t; 1 <= t ? e++ : e--) {
                n.push(this.$el.append("<i class='fa fa-star-o'></i>"))
            }
            return n
        };
        t.prototype.setRating = function (e) {
            ...
            this.syncRating();
            return this.$el.trigger("ratings:change", e)
        };
        t.prototype.syncRating = function (e) {
            ...
            if (e) {
                for (t = n = 0, i = e - 1; 0 <= i ? n <= i : n >= i; t = 0 <= i ? ++n : --n) {
                    this.$el.find("i").eq(t).removeClass("fa fa-star-o").addClass("fa fa-star")
                }
            }
            if (e && e < 5) {
                for (t = r = e; e <= 4 ? r <= 4 : r >= 4; t = e <= 4 ? ++r : --r) {
                    this.$el.find("i").eq(t).removeClass("fa fa-star").addClass("fa fa-star-o")
                }
            }
            if (!e) {
